...
var CardGroup = function CardGroup(_ref) {
  ...
  var setCardHeight = function setCardHeight() {
    root.requestAnimationFrame(function () {
      ...
      if (containerNode) {
        sameHeight(containerNode.querySelectorAll(":not(.".concat(prefix, "--card__video) .").concat(prefix, "--card__heading")), 'md');
        sameHeight(containerNode.querySelectorAll(":not(.".concat(prefix, "--card__video) .").concat(prefix, "--card__copy")), 'md');
        sameHeight(containerNode.querySelectorAll(".".concat(prefix, "--card__eyebrow")), 'md');
        sameHeight(containerNode.querySelectorAll(".".concat(prefix, "--card--link")), 'md');
      }
    });
  };

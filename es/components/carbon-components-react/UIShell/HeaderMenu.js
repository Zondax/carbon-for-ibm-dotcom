  ...
  _createClass(HeaderMenu, [{
    ...
    value: function render() {
      ...
      return React.createElement("li", {
        ...
        role: "menuitem",
        tabIndex: 0
      }, _defineProperty(_extends2, "ref", this.menuLinkRef), _defineProperty(_extends2, "aria-selected", selected ? 'true' : 'false'), _extends2), accessibilityLabel), menuLinkName, React.createElement(MenuContent, null)), React.createElement("ul", _extends({}, accessibilityLabel, {

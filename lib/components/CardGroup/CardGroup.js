...
var CardGroup = function CardGroup(_ref) {
  ...
  var setCardHeight = function setCardHeight() {
    _windowOrGlobal.default.requestAnimationFrame(function () {
      ...
      if (containerNode) {
        (0, _sameHeight.default)(containerNode.querySelectorAll(":not(.".concat(prefix, "--card__video) .").concat(prefix, "--card__heading")), 'md');
        (0, _sameHeight.default)(containerNode.querySelectorAll(":not(.".concat(prefix, "--card__video) .").concat(prefix, "--card__copy")), 'md');
        (0, _sameHeight.default)(containerNode.querySelectorAll(".".concat(prefix, "--card__eyebrow")), 'md');
        (0, _sameHeight.default)(containerNode.querySelectorAll(".".concat(prefix, "--card--link")), 'md');
      }
    });
  };

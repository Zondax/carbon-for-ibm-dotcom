...
var _MastheadLogo = _interopRequireDefault(require("@carbon/ibmdotcom-services/lib/services/MastheadLogo/MastheadLogo"));
...
var IbmLogo = function IbmLogo(_ref) {
  ...
  }, _react.default.createElement(_ConditionalWrapper.default, {
    condition: logoData && logoData.tooltip !== undefined,
    wrapper: function wrapper(children) {
      return _react.default.createElement(_TooltipDefinition.default, {
        tooltipText: logoData.tooltip
      }, children);
    }
  }, useAlternateLogo ? _react.default.createElement("a", {
    // eslint-disable-line
    "aria-label": "IBM\xAE",
    "data-autoid": autoid,
  ...
  }, !useAlternateLogo && _react.default.createElement(MastheadLogo, null))));
};

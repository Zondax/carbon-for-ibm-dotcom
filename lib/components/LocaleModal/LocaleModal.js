...
var LocaleModal = function LocaleModal(_ref) {
  ...
  return _react.default.createElement(_ComposedModal.default, {
    ...
    label: [_react.default.createElement(_LinkWithIcon.LinkWithIcon, {
      href: "#",
      iconPlacement: 'left'
    }, _react.default.createElement("span", null, modalLabels.headerTitle), _react.default.createElement(_.default, {

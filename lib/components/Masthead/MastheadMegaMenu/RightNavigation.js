...
var RightNavigation = function RightNavigation(_ref) {
  ...
  return _react.default.createElement("div", {
    ...
    className: (0, _classnames2.default)("".concat(prefix, "--masthead__megamenu__categories"), (0, _defineProperty2.default)({}, "".concat(prefix, "--masthead__megamenu--hasHighlights"), hasHighlights))

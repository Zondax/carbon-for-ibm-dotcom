...
var MastheadSearch = function MastheadSearch(_ref) {
  ...
  var placeHolderText = _ref.placeHolderText,
      ...
      rest = (0, _objectWithoutProperties2.default)(_ref, ["placeHolderText", "renderValue", "searchOpenOnload", "navType", "customTypeaheadApi"]);
  ...
  var className = (0, _classnames.default)((_cx = {}, (0, _defineProperty2.default)(_cx, "".concat(prefix, "--masthead__search"), true), (0, _defineProperty2.default)(_cx, "".concat(prefix, "--masthead__search--active"), state.isSearchOpen), _cx)); // pass search state back to <Masthead />
